...
class EquipmentLossesViewController: UIViewController {
    ...
    private lazy var aircraftTitle: UILabel = {
    ...
    private lazy var helicopterTitle: UILabel = {
    ...
    private lazy var tankTitle: UILabel = {
    ...
    private lazy var artilleryTitle: UILabel = {
    ...
    private lazy var mrlTitle: UILabel = {
    ...
    private lazy var militaryTitle: UILabel = {
    ...
    private lazy var fuelTankTitle: UILabel = {
    ...
    private lazy var droneTitle: UILabel = {
    ...
    private lazy var navalShipTitle: UILabel = {
    ...
    private lazy var antiAircraftTitle: UILabel = {
    ...
    private lazy var specialEquipTitle: UILabel = {
    ...
    private lazy var mobileSRBMTitle: UILabel = {
    ...
    private lazy var cruiseMissilesTitle: UILabel = {
    ...
    func setupUI(_ equip: Equipment) {
        if let aircraftCount = equip.aircraft {
            aircraftTitle.text = "Destroyed \(aircraftCount) aircrafts"

        }

        if let helicoptersCount = equip.helicopter {
            helicopterTitle.text = "Destroyed \(helicoptersCount) helicopters"

        }

        if let tankCount = equip.tank {
            tankTitle.text = "Destroyed \(tankCount) tanks"
        ...
        if let artilleryCount = equip.artillery {
            artilleryTitle.text = "Destroyed \(artilleryCount) artillery"
        }

        if let mrlCount = equip.MRL {
            mrlTitle.text = "Destroyed \(mrlCount) MRL"
        }

        if let militaryCount = equip.militaryAuto {
            militaryTitle.text = "Destroyed \(militaryCount) militaryAuto"
        }

        if let fuelTanksCount = equip.fuelTank {
            fuelTankTitle.text = "Destroyed \(fuelTanksCount) fueltanks"
        }

        if let droneCount = equip.drone {
            droneTitle.text = "Destroyed \(droneCount) drones"
        }

        if let navalShipCount = equip.navalShip {
            navalShipTitle.text = "Destroyed \(navalShipCount) ships"
        }

        if let antiAircraftCount = equip.antiAircraft {
            antiAircraftTitle.text = "Destroyed \(antiAircraftCount) antiAircrafts"
        }

        if let specialEquipCount = equip.specialEquip {
            specialEquipTitle.text = "Destroyed \(specialEquipCount) equips"
        }

        if let srbmCount = equip.mobileSRBM {
            mobileSRBMTitle.text = "Destroyed \(srbmCount) srbm"
        }

        if let misslesCount = equip.cruiseMissiles {
            cruiseMissilesTitle.text = "Destroyed \(misslesCount) missles"
        }
